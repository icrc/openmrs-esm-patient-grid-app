    ...
    expect(data).toEqual([
      {
        ...
        data: [
          ...
          [
            ...
            columnNameToHeaderLabelMap[patientDetailsPatientId01ColumnName],
            columnNameToHeaderLabelMap[patientDetailsPatientId02ColumnName],
          ...
          ['Patient 1', '111', '111111', 'Country 1', 'Structure 1', 'O', '18', 'Value 1'],
          ['Patient 1', '111', '111111', 'Country 1', 'Structure 1', 'O', '18', 'Value 2'],
          ['Patient 1', '111', '111111', 'Country 1', 'Structure 1', 'O', '18', 'Value 3'],
          ['Patient 2', '222', '222222', 'Country 1', 'Structure 1', 'O', '18', 'Value 4'],
        ],
      },
      {
        header: 'f2',
        data: [
          ...
          ['Patient 1', '111', '111111', 'Country 1', 'Structure 1', 'O', '18'],
          ['Patient 2', '222', '222222', 'Country 1', 'Structure 1', 'O', '18'],
          ['Patient 2', '222', '222222', 'Country 1', 'Structure 1', 'O', '18'],
        ],
      },
    ]);
